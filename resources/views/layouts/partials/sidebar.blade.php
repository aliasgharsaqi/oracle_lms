...
<nav class="d-flex flex-column flex-shrink-0 p-3 sidebar" id="sidebarMenu">
    ...
    <div class="sidebar-brand-container d-flex justify-content-between align-items-center">
        <a href="/" class="d-flex align-items-center text-white text-decoration-none">
            <div
                class="sidebar-brand-icon bg-white rounded-circle d-flex align-items-center p-2 justify-content-center">
        ...
        @can('Manage Fees')
            <li class="nav-item">
                ...
                <ul class="list-unstyled ps-3 dropdown-submenu"
                    style="display: {{ request()->routeIs(['fees.payments.*', 'fees.plans.*']) ? 'block' : 'none' }};">
        ...
        @can('teacher_diary')
            <li>
                <a href="{{ route('teacher_diary') }}"
                    ...
                    style="gap: 6px; padding: 2px 12px;">
                    <i class="bi bi-journal-check"></i> Teacher Diary
                </a>
            </li>
        @endcan
